...
-- 
-- PROBLEM:
--   Milestones INSERT/UPDATE/SELECT all fail with 42501 (RLS violation) for
--   members because the only policy (milestones_write) uses for all and
--   requires is_admin() or is_manager().
--
-- ROOT CAUSE:
...
--   covering all operations including SELECT.
--
-- FIX:
